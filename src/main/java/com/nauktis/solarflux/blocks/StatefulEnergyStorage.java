...
public class StatefulEnergyStorage implements IEnergyStorage {
	protected static final String NBT_ENERGY = "SFESEnergy";
	...
	public String toString() {
		return Objects.toStringHelper(this).add("energy", getEnergyStored()).add("capacity", getMaxEnergyStored()).add("maxTransferReceive", getMaxTransferReceive())
				.add("maxTransferExtract", getMaxTransferExtract()).toString();
	}
}
